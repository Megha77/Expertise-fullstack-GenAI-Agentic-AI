...
'''
URL-https://streamlit.io/playground?example=dataframes
to run this code, copy and paste it into a file called StreamlitDataframe.py and run the following command in your terminal:
streamlit run StreamlitDataframe.py
'''
