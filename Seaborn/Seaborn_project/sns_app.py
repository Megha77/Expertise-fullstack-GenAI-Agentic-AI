...
st.title('tips data visualization app')
...
# PS D:\MEGH@\AI_Engineer\Practice\Expertise-fullstack-GenAI-Agentic-AI\Seaborn\Seaborn_project> python -m streamlit run sns_app.py
