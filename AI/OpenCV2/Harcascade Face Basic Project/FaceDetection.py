...
face_classifier = cv2.CascadeClassifier(r"D:\MEGH@\AI_Engineer\Practice\Live Class Practice\AI\OpenCV2\Harcascade Face Basic Project\haarcascade_frontalface_default.xml")# Load the image
image = cv2.imread(r"D:\MEGH@\AI_Engineer\Practice\Live Class Practice\AI\OpenCV2\Harcascade Face Basic Project\Image1.jpg")
